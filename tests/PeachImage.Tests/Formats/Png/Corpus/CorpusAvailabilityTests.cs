...
public class CorpusAvailabilityTests
{
    ...
    public void Corpus_IsAvailable()
    {
        ...
        {
            Assert.Skip("External PNG test corpus (PngSuite) is not available (no network, or PEACHIMAGE_SKIP_CORPUS_FETCH is set). Corpus-driven tests will report zero cases.");
        }
    }
}
