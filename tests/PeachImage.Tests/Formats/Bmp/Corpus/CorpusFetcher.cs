...
/// <summary>
/// Downloads the <c>bmp-conformance</c> subtree of the Imazen <c>codec-corpus</c> repository into the
...
/// no full-repo clone. Mirrors the Jpeg corpus fetcher's approach, scoped to a single repo/path.
/// </summary>
internal static class CorpusFetcher
{
    private static readonly (string Owner, string Repo, string Branch, string[] Paths, string Destination) ImazenSource =
        ("imazen", "codec-corpus", "main", ["bmp-conformance"], "imazen-codec-corpus");
