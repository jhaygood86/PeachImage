...
/// corpus (if not already fetched) with no separate script or manual step required -- plain
/// <c>dotnet test</c> is sufficient. Set <c>PEACHIMAGE_SKIP_CORPUS_FETCH</c> to any value to opt out of
/// network access; corpus-driven tests then report as skipped rather than failing.
/// </summary>
