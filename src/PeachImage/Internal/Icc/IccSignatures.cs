...
/// <summary>
/// ICC profile marker/tag signature constants (ICC.1:2010 §7, §9, §10). Ported from Wacton/Unicolour's
/// <c>Icc/Signatures.cs</c> (MIT license) — see THIRD-PARTY-LICENSES.md.
/// </summary>
internal static class IccSignatures
{
    ...
    internal const string ColorSpace = "spac";
