...
/// <summary>Converts a decoded <see cref="Image"/> to the pixel format requested via <see cref="DecoderOptions.TargetPixelFormat"/>. BMP's own copy — mirrors Jpeg's converter, scoped to the formats BmpDecoder actually produces (Rgb24/Rgba32).</summary>
